  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h1 className="text-4xl font-bold mb-2">Java OAuth2 Server</h1>
          <p className="text-gray-600">Spring Boot 3.2.0 + Spring Security OAuth2</p>
        </div>
        ...
        <div className="border rounded-lg p-6">
          ...
          <dl className="space-y-2">
            <div className="flex justify-between">
              <dt className="text-gray-600">{t.servers.port}:</dt>
              <dd className="font-medium">8080</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-600">{t.servers.framework}:</dt>
              <dd className="font-medium">Spring Boot 3.2.0</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-600">{t.servers.oauthLibrary}:</dt>
              <dd className="font-medium">Spring Security OAuth2</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-600">{t.servers.database}:</dt>
      ...
      <div className="border rounded-lg p-6 mb-8">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
            <span className="font-mono text-sm">GET /api/userinfo</span>
            <span className="text-gray-600">{t.servers.userInfoEndpoint}</span>
          </div>
        </div>
      </div>
      ...
      <div className="border rounded-lg p-6">
        ...
        <div className="bg-black text-green-400 p-4 rounded font-mono text-sm h-64 overflow-y-auto">
          {logs.length > 0 ? (
            ...
            <div className="text-gray-500">{t.servers.noLogs}</div>
          )}
        </div>
      </div>
    </div>
