...
export default function PhpServerPage() {
  const { t } = useLanguage()
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h1 className="text-4xl font-bold mb-2">PHP OAuth2 Server</h1>
          <p className="text-gray-600">Slim 4 + league/oauth2-server</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="border rounded-lg p-6">
          ...
          <dl className="space-y-2">
            <div className="flex justify-between"><dt className="text-gray-600">{t.servers.port}:</dt><dd className="font-medium">8888</dd></div>
            <div className="flex justify-between"><dt className="text-gray-600">{t.servers.framework}:</dt><dd className="font-medium">Slim 4</dd></div>
            <div className="flex justify-between"><dt className="text-gray-600">{t.servers.oauthLibrary}:</dt><dd className="font-medium">league/oauth2-server</dd></div>
        ...
        <div className="border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <a href="http://localhost:8888/health" target="_blank" rel="noopener noreferrer" className="block w-full px-4 py-2 bg-gray-100 text-center rounded hover:bg-gray-200">{t.servers.openHealth}</a>
          </div>
        </div>
      </div>
